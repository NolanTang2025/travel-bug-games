...
/** UTF-8 bytes misread as Latin-1 — common LLM / transport corruption. */
...
/** LLM sometimes returns literal \\n or \\uXXXX instead of real characters. */
...
/** Repair strings on API payloads before storage / session write. */
