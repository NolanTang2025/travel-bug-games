...
import { isTextEngine, normalizePlayEngine } from "./types";
...
export const GAME_TEMPLATES: GameTemplateDef[] = [
  ...
  { id: "desert_snap", engine: "falling_catch", nameZh: "Desert Snap", scenes: ["沙漠", "干旱", "骆驼", "热浪"], defaultTarget: "🐪", defaultObstacle: "🌪️", defaultBg: "linear-gradient(180deg, #e8c070, #a06828)", defaultInstruction: "Slide left/right — catch the good, dodge the sand", duration: 35 },
  { id: "mirage_photo", engine: "falling_catch", nameZh: "Mirage Shot", scenes: ["荒漠", "绿洲", "幻影", "远"], defaultTarget: "🌴", defaultObstacle: "☀️", defaultBg: "linear-gradient(180deg, #f0d090, #c08030)", defaultInstruction: "Move the basket — catch oasis vibes, dodge the glare", duration: 34 },
  ...
  { id: "museum_snap", engine: "falling_catch", nameZh: "Museum Shutter", scenes: ["博物馆", "展览", "艺术", "静"], defaultTarget: "🖼️", defaultObstacle: "🚫", defaultBg: "linear-gradient(180deg, #4a4a55, #252530)", defaultInstruction: "Slide the basket — catch exhibits, dodge the guards", duration: 35 },
  ...
  { id: "wildlife_snap", engine: "falling_catch", nameZh: "Wildlife Snap", scenes: ["动物", "观鸟", "森林", "国家公园"], defaultTarget: "🦌", defaultObstacle: "📯", defaultBg: "linear-gradient(180deg, #3d6a40, #1a3820)", defaultInstruction: "Move the net — catch wildlife, dodge loud noises", duration: 35 },
...
export function resolveSpec(parsed: Record<string, unknown>): import("./types").AIGameTemplateSpec {
  ...
  const engine = normalizePlayEngine(
    tpl.engine ||
  ...
  return {
    ...
    instruction:
      engine === "falling_catch" && parsed.engine === "shutter_snap"
        ? "Slide left/right — catch the good, dodge the bad"
        : normalizeGameText(parsed.instruction) || tpl.defaultInstruction,
    textRounds,
